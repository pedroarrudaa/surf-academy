...
const LogoIcon = () => (
  <div className="p-1.5 rounded">
    <svg width="32" height="32" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#73ebda" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
    ...
    <div className="flex items-center space-x-2 select-none flex-shrink-0">
      ...
      {withText && (
        <h1 className="text-xl font-bold">
          <span className="text-[#73ebda]">Surf</span><span className="text-gray-700">Academy</span>
        </h1>
      )}
    </div>
  );
